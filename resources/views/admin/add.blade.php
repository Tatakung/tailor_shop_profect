    ...
    <div class="container d-flex justify-content-start">
        ...
        <div class="card border-0">
            ...
            <form action="{{ route('new.saveadddress') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-sm-4">
                    <label class="form-label" for="dresscode">แบบชุด : </label>
                    <input type="number" name="dresscode" id="dresscode" value="" class="form-control shadow-sm p-3 mb-2 bg-body-tertiary rounded" readonly>
                </div>
                ...
                <div class="col-sm-4">
                    <label for="sizename">ไซส์</label>
                    <input type="text" name="sizename" id="sizename" class="form-control shadow-sm p-3 mb-2 bg-body-tertiary rounded" required>
                </div>
                <div class="col-sm-4">
                    <label for="amount">จำนวนชุด</label>
                    <input type="number" name="amount" id="amount" class="form-control shadow-sm p-3 mb-2 bg-body-tertiary rounded" required>
                </div>
                

                <div class="col-sm-6">
                    <label for="price">ราคาชุด / วัน</label>
                    <input type="number" name="price" id="price" class="form-control shadow-sm p-3 mb-2 bg-body-tertiary rounded" placeholder="จำนวนบาท" required>
                </div>


                <div class="col-sm-6">
                    <label for="deposit">ราคามัดจำ</label>
                    <input type="number" name="deposit" id="deposit" class="form-control shadow-sm p-3 mb-2 bg-body-tertiary rounded" placeholder="จำนวนบาท" required>
                </div>
