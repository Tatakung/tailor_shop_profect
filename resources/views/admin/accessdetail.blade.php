    ...
    <div class="table-responsive text-start" style="width: 100%;">
        ...
        <div class=”grid-container”>
            <div class="card mb-3 border-2" style="max-width: 1080px;">
                <div class="row g-0">
                    <div class="col-md-4">
                        <img src="{{ asset('storage/' . $access->accessory_image) }}" class="img-fluid rounded-start" alt="" width="240" height="210"> <!--ค่อยปรับตามรูปที่ต้องการ -->
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="card-title">{{-- {{$access}} --}}</h5>
                            <p class="card-text">
                                <span style="font-weight: bold;">ประเภทเครื่องประดับ : </span> {{ $access->accessory_name }}
                            </p>
                            <p class="card-text">
                                <span style="font-weight: bold;">จำนวนเครื่องประดับ : </span> {{ $access->accessory_count }}
                            </p>
                            <p class="card-text">
                                <span style="font-weight: bold;">ราคา : </span> {{ $access->accessory_price }}
                            </p>
                            <p class="card-text">
                            ...
                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modaleditaccess">แก้ไข</button>
                            <button type="button" data-toggle="modal" data-target="#history" class="btn btn-primary">ประวัติการแก้ไข</button>
                            @if (session('success'))
                            <div class="alert alert-success">
                                {{ session('success') }}
                            </div>
